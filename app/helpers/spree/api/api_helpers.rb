  ...
  module Api
    module ApiHelpers
      ...
      @@product_attributes = [
        ...
        :slug, :meta_description, :meta_keywords, :shipping_category_id, :updated_at,
        :taxon_ids, :total_on_hand, :net_rate, :due_rate
      ]
      ...
      @@product_details_attributes = [:set_size]
      ...
      @@taxon_attributes = [
        :id, :name, :pretty_name, :description, :permalink, :parent_id,
        :taxonomy_id, :updated_at, :is_item
      ]
