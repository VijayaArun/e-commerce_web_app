 ...
 * Image cell renderer
 * @constructor
 * @class Class to render a cell with image
 */

function ImageCellRenderer(config) { this.init(config); }
ImageCellRenderer.prototype = new CellRenderer();
ImageCellRenderer.prototype.render = function(cell, value)
{
    cell.innerHTML = value ? "<img src=\""+value+"\" style = 'height: 60px;'></img>" : "<div>dummy</div>";
};
